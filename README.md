# This is the version of Marlin 1.1.x-bugfix customized for Ender3 Pro & BLTouch 3.1

 * Using BLTouch mount from: https://www.thingiverse.com/thing:3003725
 * Date of download is 14 August 2020.
 * Follow steps from [Teaching Tech video](https://www.youtube.com/watch?v=sOFxalLOZOI) for BLTouch [Method 2]

 There is a [reddit thread to use BLTouch with ICSP](https://www.reddit.com/r/ender3/comments/c02q88/the_definitive_guide_to_wiring_bltouch_v3_on_icsp/), that **DID NOT** work for BLTouch 3.1

There are a lot of changes that keep popping up. Hopefully, I'll not be making anymore firmware upgrades for now :)
